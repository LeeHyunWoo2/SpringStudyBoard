...
public class BoardControllerTests {
	...
	public void testGet()throws Exception{
		log.info("결과 : " +
				...
				.andReturn()		//결과를
				.getModelAndView()
				.getModelMap()	// select들은 모델맵으로 리턴함
				);
	} // 결과 : {board=BoardVO(bno=6, title=테스트 제5목, content=테스트 내5용, writer=5kkw, regdate=Tue Aug 20 11:13:45 KST 2024, updateDate=Tue Aug 20 11:13:45 KST 2024)
